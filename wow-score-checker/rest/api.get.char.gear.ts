...
export default class ApiGetCharGear {
    ...
    public async getCharacterAppearace() {
        ...
        const data = await api.query(
            '/profile/wow/character/' + this.realm + '/' + this.name + '/equipment?namespace=profile-' + this.region + '&locale=en_US&access_token=' + _accessToken
        )
