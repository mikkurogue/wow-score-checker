...
export default class ApiGetCharAppreance {
    ...
    public async getCharacterAppearace() {
        ...
        const data = await api.query(
            '/profile/wow/character/' + this.realm + '/' + this.name + '/appearance?namespace=profile-' + this.region + '&locale=en_US&access_token=' + _accessToken
        )
